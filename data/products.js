...
const PRODUCTS = [
  ...
  // ──────────────────── EVENTS & OCCASIONS ─────────────────────────────────
  {
    ...
    badge: "Birthday",
    description:
      "A celebration-worthy vanilla or chocolate sponge smothered in rainbow sprinkle buttercream, topped with a personalised name plaque and sparkler candles. Available in any colour theme.",
    serves: "10–12",
    allergens: ["Gluten", "Dairy", "Eggs"],
    available: true,
    image: "https://loremflickr.com/800/600/birthday,cake?lock=200",
    altText: "Colourful birthday cake with sprinkles and candles",
    featured: true,
  },
  {
    id: "e002",
    ...
    tagline: "A sweet toast to your love story",
    price: 22000,
    badge: "Anniversary",
    description:
      "Two-tier heart-shaped cake in red velvet and champagne sponge, decorated with fresh roses, gold leaf accents, and a personalised fondant message. Perfect for anniversaries and date nights.",
    serves: "12–15",
    allergens: ["Gluten", "Dairy", "Eggs"],
    available: true,
    image: "https://loremflickr.com/800/600/romantic,cake?lock=210",
    altText: "Elegant heart-shaped anniversary cake with roses and gold leaf",
    featured: true,
  },
  {
    id: "e003",
    category: "events",
    name: "Valentine's Dessert Box for Two",
    tagline: "Romance in every bite",
    price: 9500,
    badge: "Valentine's",
    description:
      "A curated gift box for two — mini red velvet cupcakes, chocolate truffles, heart-shaped shortbread, and seasonal treats. Delivered in a premium red gift box with hand-tied ribbon.",
    serves: "2",
    allergens: ["Gluten", "Dairy", "Eggs", "Nuts"],
    available: true,
    image: "https://loremflickr.com/800/600/dessert,romantic?lock=220",
    altText: "Romantic Valentine dessert gift box with cupcakes and truffles",
    featured: false,
  },
  {
    id: "e004",
    ...
    tagline: "Honour a lifetime of great work",
    price: 19000,
    badge: "Retirement",
    description:
      "A distinguished two-tier cake featuring the retiree's name, years of service, and a custom fondant motif (briefcase, golf club, or your request). Available in any flavour.",
    serves: "15–20",
    allergens: ["Gluten", "Dairy", "Eggs"],
    available: true,
    image: "https://loremflickr.com/800/600/celebration,cake?lock=230",
    altText: "Elegant retirement celebration cake with personalised decoration",
    featured: false,
  },
  {
    id: "e005",
    ...
    tagline: "Welcome the little one in sweetness",
    price: 18000,
    badge: "Baby Shower",
    description:
      "A dreamy pastel two-tier cake (blue, pink, or gender-neutral) with teddy bear fondant figures, a baby onesie topper, and the baby's name or gender reveal message.",
    serves: "12–15",
    allergens: ["Gluten", "Dairy", "Eggs"],
    available: true,
    image: "https://loremflickr.com/800/600/baby,cake?lock=240",
    altText: "Pastel baby shower cake with teddy bear fondant topper",
    featured: false,
  },
  {
    id: "e006",
    ...
    tagline: "Celebrate the achievement of a lifetime",
    price: 17000,
    badge: "Graduation",
    description:
      "Single or two-tier cake in the graduate's school colours, with a fondant mortar board, diploma scroll, and personalised name and qualification. A proud family moment made sweeter.",
    serves: "12–15",
    allergens: ["Gluten", "Dairy", "Eggs"],
    available: true,
    image: "https://loremflickr.com/800/600/graduation,cake?lock=250",
    altText: "Graduation celebration cake with mortar board decoration",
    featured: false,
  },
  {
    id: "e007",
    category: "events",
    name: "Corporate Event Platter",
    tagline: "Impress clients and reward your team",
    price: 25000,
    badge: "Corporate",
    description:
      "Premium assorted platter for corporate events, product launches, and office celebrations. Includes mini cupcakes (12), brownies (6), shortbread (12), and chin chin — elegantly boxed with colour-matched ribbon.",
    serves: "20–30",
    allergens: ["Gluten", "Dairy", "Eggs", "Nuts"],
    available: true,
    image: "https://loremflickr.com/800/600/dessert,platter?lock=260",
    altText: "Elegant corporate dessert platter with assorted baked goods",
    featured: true,
  },
  {
    id: "e008",
    category: "events",
    name: "Engagement Party Cake",
    tagline: "The sweetest start to forever",
    price: 28000,
    badge: "Engagement",
    description:
      "A glamorous two-tier cake for the big yes. Features a ring-box fondant topper, champagne buttercream, edible gold drip, and a personalised couple plaque — a true celebration showstopper.",
    serves: "20–25",
    allergens: ["Gluten", "Dairy", "Eggs"],
    available: true,
    image: "https://loremflickr.com/800/600/engagement,cake?lock=270",
    altText: "Glamorous engagement party cake with ring-box topper and gold drip",
    featured: false,
  },
];
